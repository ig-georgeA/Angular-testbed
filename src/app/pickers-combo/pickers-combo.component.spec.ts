...
describe('PickersComboComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      imports: [ NoopAnimationsModule, FormsModule, IgxSelectModule, IgxInputGroupModule, IgxIconModule, IgxComboModule, IgxButtonModule, IgxRippleModule, IgxToggleModule, IgxDatePickerModule, IgxDropDownModule ]
    })
    .compileComponents();
  });
