...
import { IgxPivotGridModule, IgxPivotGridModule } from '@infragistics/igniteui-angular';
...
describe('PivotGridComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      imports: [ NoopAnimationsModule, FormsModule, IgxPivotGridModule, IgxPivotGridModule ]
    })
    .compileComponents();
  });
